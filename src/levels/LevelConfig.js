...
export const LEVELS = [
  // ===== LEVEL 1: 新手保护期 =====
  {
    ...
    startResource: 75,
    waves: [
      W([{ type: 'client', count: 2, delay: 2.5 }]),
      W([{ type: 'client', count: 3, delay: 2 }]),
      W([{ type: 'client', count: 3, delay: 1.5, hpMul: 1.3 }]),
    ],
  ...
  // ===== LEVEL 2: KPI风暴 =====
  {
    ...
    startResource: 80,
    waves: [
      W([{ type: 'client', count: 2, delay: 2 }, { type: 'kpi', count: 1, delay: 2.5 }]),
      W([{ type: 'client', count: 3, delay: 1.8 }, { type: 'kpi', count: 1, delay: 2 }]),
      W([{ type: 'client', count: 3, delay: 1.5 }, { type: 'kpi', count: 2, delay: 2 }]),
      W([{ type: 'client', count: 3, delay: 1.5 }, { type: 'kpi', count: 2, delay: 1.5, hpMul: 1.2 }]),
    ],
  ...
  // ===== LEVEL 3: 甲方地狱 =====
  {
    ...
    waves: [
      ...
      W([{ type: 'client', count: 3, delay: 1.5 }, { type: 'kpi', count: 2, delay: 2 }]),
      W([{ type: 'client', count: 4, delay: 1.3 }, { type: 'kpi', count: 2, delay: 1.5 }]),
      W([{ type: 'client', count: 4, delay: 1.2 }, { type: 'kpi', count: 2, delay: 1.5 }]),
      W([{ type: 'client', count: 4, delay: 1.2, hpMul: 1.2 }, { type: 'kpi', count: 2, delay: 1.5 }]),
    ],
    unlocks: ['shield', 'read'],
